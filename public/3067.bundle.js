"use strict";(self.webpackChunkpersonas=self.webpackChunkpersonas||[]).push([[3067],{25448:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ge,W3mModal:()=>ve,W3mModalBase:()=>me});var o=i(86161),a=i(25707),r=i(81413),s=i(24376),n=i(42733),c=i(84833),l=i(6056),w=i(36010),d=i(88249),p=i(78508),u=i(1122);const h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var m=i(68996),v=i(21871),g=i(26742),y=i(52855),f=i(26109),b=i(43494);const k=o.AH`
  :host {
    display: block;
